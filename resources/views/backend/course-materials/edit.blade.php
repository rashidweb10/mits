<form id="edit" action="{{ route('course-materials.update', $pageData->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="form-group mb-2">
                ...
                <div class="input-group" data-toggle="aizuploader" data-type="all" data-multiple="false">
                    ...
                    <input type="hidden" name="attachments" class="selected-files" value="{{ $pageData->attachments }}">
                </div>
